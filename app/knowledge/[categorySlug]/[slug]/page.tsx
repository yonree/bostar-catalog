    ...
    <>
      ...
      <section className="section">
        <div className="container max-w-4xl">
          <Breadcrumb items={[{ label: '知识中心', href: '/knowledge' }, { label: article.title }]} />
          {article.coverImage ? (
      ...
      <FaqSection faqs={faqs} description="关于本知识主题的常见疑问与解答。" />
      <section className="section section-alt border-y border-line">
        <div className="container max-w-4xl">
          <h2 className="mb-6 text-2xl font-black text-ink">咨询相关工艺问题</h2>
